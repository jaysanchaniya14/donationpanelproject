...
@section('title', config('app.name') .' | Edit Sub Project')
...
@section('top-bar')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('admin.sub-projects') }}" class="text-muted text-hover-primary">Sub Projects</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-200"></span>
        </li>
        <li class="breadcrumb-item text-dark">Edit Sub Project</li>
    </ul>
@endsection
                ...
                <form method="post" enctype="multipart/form-data" id="project-form">
                    ...
                    <div class="card-header border-0 cursor-pointer">
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">Sub Project Details</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-12">
                                <label class="required form-label">Sub Project title</label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-solid" name="donation_type_en"
                                       placeholder="Donation type" required value="{{ $project->donation_type['en'] }}" readonly>
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-solid" name="donation_type_de"
                                       placeholder="Donation type" required value="{{ $project->donation_type['de'] }}" readonly>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group input-group-solid">
                                    ...
                                    <input type="number" step="any" name="exchange_rate" class="form-control" readonly required value="{{ $project->exchange_rate }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            @if($project->parent_project->type == "ongoing")
                                <div class="col-md">
                                    <label class="required form-label">Quantity</label>
                                    <input type="number" step="1" name="quantity" class="form-control form-control-solid" value="{{ ceil($project->goal / $project->exchange_rate) }}">
                                </div>
                            @endif
                            <div class="col-md fixed-only">
                                ...
                                <div class="input-group input-group-solid">
                                    ...
                                    <input type="number" name="project_goal" class="form-control" value="{{ $project->goal }}"
                                        @readonly($project->parent_project->type == "ongoing")>
                                </div>
                            </div>
                            <div class="col-md">
...
@section('scripts')
    <script>
        ...
        $("input[name='target_date']").daterangepicker({
            ...
            showDropdowns: true,
            autoApply: true,
            minDate: new Date('{{$project->parent_project->start_date}}'),
            maxDate: new Date('{{$project->parent_project->end_date}}'),
            locale: {
        ...
        $("input[name='quantity']").change(function () {
            $("input[name='project_goal']").val($(this).val() * $("input[name='exchange_rate']").val());
        })
        ...
        $("#project-form").submit(function (e){
            ...
            var url = '{{ route('admin.sub-projects.update', ['project' => $project->id]) }}';
            $.ajax({
                url: url,
                method:'POST',
                data: frm_data,
